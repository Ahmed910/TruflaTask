...
class MoviesController extends Controller
{
    ...
    public function index(){
        ...
        return $this->apiResponse($top_rated_data);
    ...
    public function getMoviesListByCategoryId(Request $request)
    {

        $moviesID=DB::table('categories_movies')->where('category_id',$request->category_id)->pluck('movies_id');
        $movies=Movies::whereIn('id',$moviesID)->get();
    ...
    public function sortMovies()
    {
        ...
        $sorted_movies=Movies::orderBy('popularity', 'DESC')->orderBy('vote_count','ASC')->get();

        return $this->apiResponse($sorted_movies);
